...
// PlayStore অরিজিনাল আইকন যুক্ত করা হলো
const PlayStoreIcon = () => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[28px] overflow-hidden shadow-2xl border border-slate-100 dark:border-slate-800 animate-in zoom-in-95 duration-200">
            ...
            <div className="p-8">
              ...
              {/* Solid Premium Regenerate Button */}
              <button onClick={handleGenerateKey} disabled={generating}
                className="w-full py-4 mt-6 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 shadow-md">
